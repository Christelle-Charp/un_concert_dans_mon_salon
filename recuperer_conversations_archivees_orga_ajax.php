...
Controleur pour Ajax:
    Récupérer liste des conversations archivées orga
Parametre: 
    Neant
...
$list = $utilisateur->recupererConversations(2, 2);


// Afficher la page: 
include "templates/fragments/liste_conversations_organisateur.php";