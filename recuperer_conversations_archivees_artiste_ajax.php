...
Controleur pour Ajax:
    Récupérer liste des conversations archivées artiste
Parametre: 
    Neant
...
$list = $utilisateur->recupererConversations(1, 2);

// Afficher la page: 
include "templates/fragments/liste_conversations_artiste.php";